...
const PillBottleCaptureScreen = () => {
  ...
  return (
    <View style={{ flex: 1, padding: 16 }}>
      <Text style={{ fontSize: 18, marginBottom: 12 }}>Capture Pill Bottle</Text>
      ...
      {imageUri ? (
        <View style={{ marginTop: 16 }}>
          ...
          <Text style={{ marginTop: 8, color: '#555' }}>Image captured. Processing not implemented yet.</Text>
        </View>
      ) : null}
    </View>
  );
...
export default PillBottleCaptureScreen;
