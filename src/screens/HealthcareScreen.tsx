    ...
    <View style={{ flex: 1 }}>
      ...
      {tab === 'meds' ? (
        <View style={{ flex: 1, padding: 16 }}>
          <Text style={{ fontSize: 18, marginBottom: 8 }}>Medications</Text>
          ...
          <TouchableOpacity onPress={addMed} style={{ backgroundColor: '#111', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, marginBottom: 12, alignSelf: 'flex-start' }}>
